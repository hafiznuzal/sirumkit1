		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12" style="color:#446CB3">
				   <h1 class="page-header">Rekapitulasi Pembangunan Perkecamatan se-Kabupaten Siodarjo</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class ="row">
				<div class ="col-lg-11">
					...
					<div class ="panel panel-primary">
						<div class="panel-heading">
							...
							<i class="fa fa-list"></i> Rekapitulasi Pembangunan Perkecaamatan se-Kabupaten Sidoarjo
						</div>
								...
								<table id="pembangunanAll" class="table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th style="min-width: 400px;">Kecamatan</th>
											<th style="min-width: 150px;">Jumlah Lokasi Perumahan</th>
...
$(document).ready(function(){
	...
	$('#excelPemDownload').click(function(){
		window.location="<?php echo site_url(); ?>report/rekapitulasi_pembangunan_kecamatan_excel/"+$('#tahunOpt').val()+"/"+$('#periodeOpt').val();
	})
	$('#pdfPemDownload').click(function(){
		window.location="<?php echo site_url(); ?>create_pdf/rekapitulasi_pembangunan_kecamatan_pdf/"+$('#tahunOpt').val()+"/"+$('#periodeOpt').val();
	})
	function changeDataPem()
	{
		
		window.location="<?php echo site_url() ?>report/rekapitulasi_pembangunan_kecamatan/"+$('#tahunOpt').val()+"/"+$('#periodeOpt').val();
